...
1. `doc/xmi/00-overview.md`
2. `doc/xmi/01-instance-patterns.md`
3. `doc/xmi/03-generation-from-ecore.md` (primary algorithmic guide)
4. `doc/xmi/02-validation-checklist.md`
5. `doc/xmi/04-debugging-runbook.md` (only if validation fails)

## Generation Algorithm
Follow `doc/xmi/03-generation-from-ecore.md` exactly. Key guidelines:
...
## Repair Protocol
Map validator errors to fixes using `doc/xmi/04-debugging-runbook.md`. Repair and retry up to 3 times before escalating.
